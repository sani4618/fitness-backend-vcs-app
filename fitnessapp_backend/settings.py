"""
Django settings for fitnessapp_backend project.
...
SECRET_KEY = 'django-insecure-@73cda(vyn!5k#jzh#a_le(7+b$y7_jx4oz_w@nt0&0cqe@anf'
...
ROOT_URLCONF = 'fitnessapp_backend.urls'
...
WSGI_APPLICATION = 'fitnessapp_backend.wsgi.application'
